...
def colors_dictionary():
    ...
    # return OrderedDict(sorted(colors.items(), key=lambda t: t[0]))
    return colors
...
def colors(n=20):
    ...
    # similar colors for different classes in the same super class
    """chosen_colors = [colors['blue'], colors['orange'], colors['green'],colors['red1'], colors['green2'], \
                     colors['orange1'], colors['orange2'], colors['blue2'], colors['purple1'], \
                     colors['brown'], colors['purple2'], colors['orange3'], colors['green3'], colors['orange4'], \
                     colors['blue3'],  colors['blue4'], colors['purple3'], colors['red2'], colors['red3'], \
                     colors['green3']]"""
    # different colors for different classes in the same super class
    chosen_colors = [colors['blue'], colors['blue'],colors['blue'],colors['blue'], colors['orange'], \
                     colors['orange'], colors['green'], colors['orange'], colors['red2'], colors['red2'], \
                     colors['orange'], colors['purple1'], colors['green'], colors['red2'], colors['green'], \
                     colors['purple1'], colors['green'], colors['red2'], colors['purple1'], colors['purple1']]
    colors = []
    for color in chosen_colors:
        colors.append((color[0] / 256, color[1] / 256, color[2] / 256))
    return colors
    #random.seed(112)
    # for i in range(n_images):  # draw from validation set n images
    #     im_id.append(random.randint(1,5000))
    # n_random = random.sample(range(len(colors)), n)
    # for i, val in enumerate(colors.values()):
    #     if i in n_random:
    #         chosen_colors.append((val[0]/256, val[1]/256, val[2]/256))
